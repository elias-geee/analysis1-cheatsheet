...
\Def \key{Asymptotische Äquivalenz}: $a_n \sim b_n :\iff \lim\limits_{n\to\infty} \frac{a_n}{b_n} = 1$

\Satz $\star$ \key{Stirling-Formel}: $n! \sim \sqrt{2\pi n}\left(\frac{n}{e}\right)^n$
